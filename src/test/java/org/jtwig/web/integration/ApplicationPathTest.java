...
public class ApplicationPathTest extends AbstractIntegrationTest {
    @Test
    public void pathTest() throws Exception {
        String content = Request.Post(serverUrl()+"/example")
                .body(new UrlEncodedFormEntity(asList(new BasicNameValuePair("one", "two"))))
                .execute().returnContent().asString();

        assertThat(content, is("Hello /example!"));
    }
    ...
    public static class HelloServlet extends HttpServlet {
        ...
        protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            renderer.inlineDispatcherFor("Hello {{ app.request.path }}!")
                    .with("another", " three ")
